function a(t){const i=window.open("","_blank");if(!i)return;const n=t.createdAt?new Date(t.createdAt.seconds*1e3).toLocaleDateString():new Date().toLocaleDateString(),e=`
    <html>
      <head>
      ...
      <body>
        <div class="header">
          <div class="logo">TSDD THEALANKAR</div>
  ...
  `;i.document.write(e),i.document.close()}export{a as p};
